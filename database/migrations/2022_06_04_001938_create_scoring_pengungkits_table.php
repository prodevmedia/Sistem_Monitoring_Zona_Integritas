...
class CreateScoringPengungkitsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('scoring_pengungkits', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('scoring_pengungkits');
    }
}
