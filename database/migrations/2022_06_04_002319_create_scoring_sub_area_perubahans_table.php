...
class CreateScoringSubAreaPerubahansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('scoring_sub_area_perubahans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('scoring_sub_area_perubahans');
    }
}
