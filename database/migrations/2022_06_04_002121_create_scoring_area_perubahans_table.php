...
class CreateScoringAreaPerubahansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('scoring_area_perubahans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('scoring_area_perubahans');
    }
}
