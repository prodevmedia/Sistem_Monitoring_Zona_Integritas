          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <button data-toggle="modal" data-target="#modal-evaluasi" onclick="evaluasi({{$item->id}})"
                  class="btn btn-sm btn-primary">Beri Evaluasi</button>
                @endif
              </td>
            </tr>
            @endforeach
...
{{-- modal evaluasi --}}
<div class="modal fade" id="modal-evaluasi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="form-group">
              <label for="nilai-rencana-kerja">Nilai Realisasi Kerja (0-100)</label>
              <input id="nilai-rencana-kerja" name="nilai" type="number" min="0" max="100" class="form-control"
                required>
            </div>
            <div class="form-group">
