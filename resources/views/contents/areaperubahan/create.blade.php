...
<div class="container-fluid py-4">    
  <div class="card">
    <div class="card-body">
      <form action="{{route('areaperubahan.store')}}" method="POST">
        @csrf        
        <label for="">Nama Area Perubahan</label><br>
        <input type="text" name="nama_area_perubahan" id="" class="form-control" placeholder="Nama Area Perubahan" required><br>
